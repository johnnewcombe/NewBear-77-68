...
.FAULT  PSHA                ; save current pattern
        LDAA 0,X
        PSHA                ; save val in failed memory location
        JSR     NEWLINE     ; print address
        JSR     PRSP        ; print a space
        PULA                ; get val in failed memory location
        JSR     ZOUT        ;  and print it
        JSR     STRING      ; add some text
        FCC     "!="
        FCB     $FF
        PULA                ; get the pattern it should be
        JSR     ZOUT        ;  and print it
        JMP     START       ; all done
...
START   LDS     #STACK      ; Set up stack for JMON
        ...
        STAA    CTRLA       ;   ACIA.A
        JSR     STRING      ; Print string...
        FCB     $0D,$0A     ; c/r l/f null `*`
        FCB     $00,'*,$FF  ; End-of-string
